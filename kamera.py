...
#mit den nächsten Zeile sollte man die Kamera einstellen können, aber es passiert leider nichts
# camera = PiCamera(resolution=(320, 240),framerate=32, hf=True, vf=True)
# camera = PiCamera()
...
# eine andere Möglichkeit, ist das Bild mit cv2.flip() zu drehen, aber da kommt ein Fehler
...
while True:
	...
	for i in range(0, detections.shape[2]):
		...
		gesicht=(startX, startY, endX, endY)
